...
export default function CharacterLoadout({ inventory }) {
  ...
  const handleConfirmRecharge = async () => {
    ...
    try {
      ...
      setError(
        err?.message || "Recharge failed. Please check your wallet and try again."
      );
    } finally {
      setSubmitting(false);
    }
        ...
        <div className="recharge-modal-backdrop" onClick={closeModal}>
          ...
          >
            ...
            <p className="recharge-text">
              Use <strong>CINDER</strong> to refill your <strong>User Energy</strong>.
            </p>
